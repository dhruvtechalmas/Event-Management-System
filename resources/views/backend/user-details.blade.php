      ...
      <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            ...
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="users"><i class="bi bi-arrow-left" aria-hidden="true"></i> Back to Users</a><a class="btn btn-primary btn-sm" href="add-user"><i class="bi bi-person-plus" aria-hidden="true"></i> Add User</a></div>
          </div>

          <section class="row g-3">
            <div class="col-12 col-xl-4">
              <div class="panel h-100 text-center profile-card">
                <div class="profile-cover"><img src="{{ url ('/backend/assets/images/png/dasher-ui-bootstrap-5.jpg') }}" alt="User workspace preview"></div>
                <div class="profile-hero">
                  <img class="avatar-img avatar-xl profile-photo" src="{{ url ('/backend/assets/images/avatar/avatar-2.jpg') }}" alt="Sarah Ahmed">
                  <h2 class="h5 mb-1">Super Admin</h2>
                ...
                <div class="info-list mt-4 text-start">
                  <div><span>Email</span><strong>SuperAdmin@example.com</strong></div>
