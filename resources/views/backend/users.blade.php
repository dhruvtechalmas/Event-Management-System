      ...
      <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
          <div class="page-heading">
            ...
            <div class="heading-actions"><a class="btn btn-outline-secondary btn-sm" href="tables"><i class="bi bi-download" aria-hidden="true"></i> Export</a><a class="btn btn-primary btn-sm" href="add-user"><i class="bi bi-person-plus" aria-hidden="true"></i> Add User</a></div>
          </div>
          ...
          <section class="panel mt-3">
            <div class="panel-header">
              ...
              <div class="d-flex flex-wrap gap-2">
                ...
                <a class="btn btn-primary btn-sm" href="add-user"><i class="bi bi-person-plus" aria-hidden="true"></i> Add User</a>
              </div>
            </div>
              ...
              <table class="table align-middle mb-0" id="usersTable" data-searchable-table>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{ url ('/backend/assets/images/avatar/avatar-2.jpg') }}" alt="Sarah Ahmed">
                        <div>
                          <p class="fw-semibold mb-0">Super Admin</p>
                          <p class="text-muted small mb-0">SuperAdmin@example.com</p>
                        </div>
                      </div>
                    </td>
                    <td>Admin</td>
                    ...
                    <td>Jan 12, 2026</td>
                    <td class="text-end"><a class="btn btn-light btn-sm" href="user-details">View</a></td>
                  </tr>
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{ url ('/backend/assets/images/avatar/avatar-2.jpg') }}" alt="Rafi Khan">
                        <div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{ url ('/backend/assets/images/avatar/avatar-3.jpg') }}" alt="Nadia Islam">
                        <div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{ url ('/backend/assets/images/avatar/avatar-4.jpg') }}" alt="Mina Torres">
                        <div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{ url ('/backend/assets/images/avatar/avatar-5.jpg') }}" alt="Jon Oliver">
                        <div>
