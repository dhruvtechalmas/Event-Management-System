                    ...
                    <form action="{{ route('events.update', $event->id) }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="event_name" name="event_name" value="{{ $event->event_name }}" type="text"
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="event_type" name="event_type" value="{{ $event->event_type }}" type="text"
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="event_date" name="event_date" value="{{ $event->event_date }}" type="date"
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="event_time" name="event_time" value="{{ $event->event_time }}" type="time"
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="event_location" name="event_location" value="{{ $event->event_location }}" type="text"
